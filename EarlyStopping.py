...
# Create the data object for the training set
train_data = Data(edge_index=data.edge_index[:, train_indices], y=data.y[train_indices], num_nodes=data.num_nodes)

# Create the data object for the validation set
val_data = Data(edge_index=data.edge_index[:, val_indices], y=data.y[val_indices], num_nodes=data.num_nodes)

# Create the data object for the test set
test_data = Data(edge_index=data.edge_index[:, test_indices], y=data.y[test_indices], num_nodes=data.num_nodes)
