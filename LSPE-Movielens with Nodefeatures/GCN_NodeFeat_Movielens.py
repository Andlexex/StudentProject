...
for i in range(30):
    ...
    class GCN_nopos(torch.nn.Module):
        def __init__(self, hidden_channels):
            ...
            self.conv1_nopos = GCNConv(19, hidden_channels)
...
# Group the data by 'Model' and calculate the average values
print(df.groupby("Model"))
average_df = df.groupby('Model').mean()

# Print the average values
print("Average values after 30 runs:")
print(average_df)              
